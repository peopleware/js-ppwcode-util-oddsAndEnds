  ...
  (function() {
    ...
    ConsoleAppender.prototype.create = function(inPage,
      ...
      this.setCommandLineObjectExpansionDepth = function(commandLineObjectExpansionDepthParam) {
        ...
        extractIntFromParam(commandLineObjectExpansionDepthParam, commandLineObjectExpansionDepth);
      };
          ...
          if (show || !initiallyMinimized) {
            var pageLoadHandler = function() {
              if (!container) {
                ...
                appender.addCssProperty("zIndex", 1000000); // Can't find anything authoritative that says how big
                                                            // z-index can be
                open();
              }
              else {
